...
The image model used by *libpninexus* is rather simple. We assume that an image 
...
* :cpp:class:`pni::tiff_reader` for reading TIFF files 
* and :cpp:class:`pni::cbf_reader` to read CBF files. 
...
.. code-block:: cpp
   ...
   pni::cbf_reader reader("image_00001.cbf");
...
.. code-block:: cpp
   ...
   using Frame = std::vector<pni::float32>;
