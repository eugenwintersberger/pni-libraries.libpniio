...
typedef uint32 source_type;

BOOST_AUTO_TEST_SUITE(convert_uint32_test)
    ...
    BOOST_AUTO_TEST_CASE(test_to_uint8)
    {
        ...
        BOOST_CHECK_EQUAL(convert<target_type>(source_type(1)),
                          target_type(1));
        BOOST_CHECK_THROW(convert<target_type>(source_type(300)),range_error);
    }
    ...
    BOOST_AUTO_TEST_CASE(test_to_uint16)
    {
        ...
        BOOST_CHECK_EQUAL(convert<target_type>(source_type(19)),
                          target_type(19));
        BOOST_CHECK_THROW(convert<target_type>(source_type(70000)),
                          range_error);
    }
    ...
    BOOST_AUTO_TEST_CASE(test_to_int8)
    {
        ...
        BOOST_CHECK_EQUAL(convert<target_type>(source_type(19)),int8(19));
    ...
    BOOST_AUTO_TEST_CASE(test_to_int16)
    {
        ...
        BOOST_CHECK_THROW(convert<target_type>(source_type(40000)),
                          range_error);
    }
    ...
    BOOST_AUTO_TEST_CASE(test_to_int32)
    {
        ...
        BOOST_CHECK_EQUAL(convert<target_type>(source_type(19)),
                          target_type(19));
        BOOST_CHECK_THROW(convert<target_type>(source_type(30000000000)),
                          range_error);
    }
