...
typedef int64 source_type;

BOOST_AUTO_TEST_SUITE(convert_int64_test)
    ...
    BOOST_AUTO_TEST_CASE(test_to_uint16)
    {
        ...
        BOOST_CHECK_THROW(convert<target_type>(source_type(-1)),
                          range_error);
    ...
    BOOST_AUTO_TEST_CASE(test_to_uint32)
    {
        ...
        BOOST_CHECK_THROW(convert<target_type>(source_type(-1)),range_error);
        BOOST_CHECK_THROW(convert<target_type>(source_type(5e+9)),range_error);
    }
    ...
    BOOST_AUTO_TEST_CASE(test_to_int32)
    {
        ...
        BOOST_CHECK_THROW(convert<target_type>(source_type(-5e+9)),
                          range_error);
        BOOST_CHECK_THROW(convert<target_type>(source_type(5e+9)),
                          range_error);
    }
