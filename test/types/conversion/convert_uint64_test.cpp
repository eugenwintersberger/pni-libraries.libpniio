...
typedef uint64 source_type;

BOOST_AUTO_TEST_SUITE(convert_uint64_test)
    ...
    BOOST_AUTO_TEST_CASE(test_to_uint8)
    {
        ...
        BOOST_CHECK_EQUAL(convert<target_type>(source_type(1)),
                          target_type(1));
        BOOST_CHECK_THROW(convert<target_type>(fails_uint),range_error);
    }
    ...
    BOOST_AUTO_TEST_CASE(test_to_int8)
    {
        ...
        BOOST_CHECK_THROW(convert<target_type>(fails_int),range_error);
    }
    ...
    BOOST_AUTO_TEST_CASE(test_to_int64)
    {
        ...
        BOOST_CHECK_EQUAL(convert<target_type>(source_type(19)),
                          target_type(19));
        BOOST_CHECK_THROW(convert<target_type>(source_type(9.3e+18)),
                          range_error);
    }
