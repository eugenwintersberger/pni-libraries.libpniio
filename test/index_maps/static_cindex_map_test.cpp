...
namespace static_cindex_map_test{
   
    typedef static_cindex_map<20>       map_type_1d;
    typedef static_cindex_map<1024,100> map_type_2d;
    typedef static_cindex_map<3,4,5>    map_type_3d;
...
//============================================================================
int static_cindex_map_test_init()
{
    using namespace static_cindex_map_test;
    
    test_suite *ts = BOOST_TEST_SUITE("static_cindex_map_test");
