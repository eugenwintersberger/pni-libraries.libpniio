...
BOOST_AUTO_TEST_CASE(test_standard)
{
  ...
  BOOST_CHECK_EQUAL(Path::to_string(p1),"test.nxs://:NXentry/:NXinstrument");
  BOOST_CHECK_EQUAL(Path::to_string(p2),"detector@NX_class");
}
...
BOOST_AUTO_TEST_CASE(test_at_root)
{
  ...
  BOOST_CHECK_EQUAL(Path::to_string(p1),"test.nxs");
  BOOST_CHECK_EQUAL(Path::to_string(p2),"/:NXentry/:NXinstrument/detector@NX_class");
}
