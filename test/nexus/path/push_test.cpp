...
BOOST_AUTO_TEST_CASE(test_front)
{
  ...
  BOOST_CHECK_EQUAL(Path::to_string(p),":NXentry/:NXinstrument");
}
...
BOOST_AUTO_TEST_CASE(test_back)
{
  ...
  BOOST_CHECK_EQUAL(Path::to_string(p),":NXinstrument/:NXdetector");
}
...
BOOST_AUTO_TEST_CASE(test_front_back)
{
  p.push_front(object_element("","NXentry"));
  p.push_back(object_element("","NXdetector"));
  BOOST_CHECK_EQUAL(Path::to_string(p),":NXentry/:NXinstrument/:NXdetector");
}
...
BOOST_AUTO_TEST_CASE(test_root_front)
{
  ...
  BOOST_CHECK_EQUAL(Path::to_string(p),"/:NXinstrument");
}
