...
GENERATE_MDIM_REFERENCE_DATA(pni::core::float32,2.3455f, -34.e+2f, -42.e-5f);
GENERATE_MDIM_REFERENCE_DATA(pni::core::float64,-1.233e+4, 239e-3, 30495.e-8);
GENERATE_MDIM_REFERENCE_DATA(pni::core::complex32,{34.f,123.e-3f},{34.e-2f,98.3f},{453.98f,-743.29f});
