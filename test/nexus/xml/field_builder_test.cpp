...
BOOST_AUTO_TEST_CASE(test_multidim_fields)
{
  ...
  BOOST_TEST(dataspace.size() == 0);
  BOOST_TEST(dataspace.type() == hdf5::dataspace::Type::SIMPLE);
  BOOST_TEST(dataset.creation_list().layout() == hdf5::property::DatasetLayout::CHUNKED);
}
