...
{
  using pni::core::shape_t;
  using array_type = pni::core::dynamic_array<int>;
  using storage_type = array_type::storage_type;
  storage_type     write_payload{1,2,3,4,5};
  pni::core::array write(array_type::create(shape_t{5},write_payload));
...
{
  using pni::core::shape_t;
  using array_type = pni::core::dynamic_array<std::string>;
  using storage_type = array_type::storage_type;
  shape_t shape{5};
