...
BOOST_AUTO_TEST_CASE(test_from_string)
{
  ...
  BOOST_CHECK_EQUAL(v.minor(),nexus::Version::NumberType(10));
  BOOST_CHECK_EQUAL(v.patch(),nexus::Version::NumberType(23));
}
...
BOOST_AUTO_TEST_CASE(test_partial_major_and_minor)
{
  ...
  BOOST_CHECK_EQUAL(v.major(),nexus::Version::NumberType(10));
  BOOST_CHECK_EQUAL(v.minor(),nexus::Version::NumberType(3));
  BOOST_CHECK_EQUAL(v.patch(),nexus::Version::NumberType(0));
}
...
BOOST_AUTO_TEST_CASE(test_to_string)
{
  ...
  BOOST_CHECK_EQUAL(nexus::Version::to_string(v),"21.0.2");
}
