...
struct int8_parser_test_fixture : parser_test_fixture<int8>
{};

BOOST_FIXTURE_TEST_SUITE(int8_parser_test,int8_parser_test_fixture)
    ...
    BOOST_AUTO_TEST_CASE(test_invalid_input)
    {
        ...
        BOOST_CHECK_THROW(p("-10a"),parser_error);
        BOOST_CHECK_THROW(p("-10a0"),parser_error);
    }
