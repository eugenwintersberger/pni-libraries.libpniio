...
#include "float128_parser_test.hpp"
#include "../../EqualityCheck.hpp"

CPPUNIT_TEST_SUITE_REGISTRATION(float128_parser_test);

//-----------------------------------------------------------------------------
void float128_parser_test::setUp() { }

//-----------------------------------------------------------------------------
void float128_parser_test::tearDown() {}

//-----------------------------------------------------------------------------
void float128_parser_test::test_regular_value()
{
...
//-----------------------------------------------------------------------------
void float128_parser_test::test_invalid_input()
{
    std::cerr<<BOOST_CURRENT_FUNCTION<<std::endl;
