...
static const double num_res = 1.e-12;

struct complex128_parser_test_fixture : parser_test_fixture<complex128>
{};

BOOST_FIXTURE_TEST_SUITE(complex128_parser_test,complex128_parser_test_fixture)
