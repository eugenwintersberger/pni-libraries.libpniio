...
void uint8_parser_test::test_invalid_input()
{
    ...
    CPPUNIT_ASSERT_THROW(p("a3"),parser_error);
    CPPUNIT_ASSERT_THROW(p("1x3"),parser_error);
    CPPUNIT_ASSERT_THROW(p("3x"),parser_error);
    CPPUNIT_ASSERT_THROW(p("-3"),parser_error);
}
