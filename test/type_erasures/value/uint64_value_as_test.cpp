...
BOOST_AUTO_TEST_SUITE(uint64_value_as_test)
    ...
    BOOST_AUTO_TEST_CASE(test_as_uint32)
    {
        ...
        BOOST_CHECK_THROW(value(value_type(8000000000)).as<target_type>(),
                             range_error);
    }
    ...
    BOOST_AUTO_TEST_CASE(test_as_int64)
    {
        ...
        BOOST_CHECK_THROW(value(value_type(9.3e+18)).as<target_type>(),
                          range_error);
    }
