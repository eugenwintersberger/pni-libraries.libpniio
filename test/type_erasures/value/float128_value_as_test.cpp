...
BOOST_AUTO_TEST_SUITE(float128_value_as_test)
    ...
    BOOST_AUTO_TEST_CASE(test_as_float32)
    {
        ...
        fixture_type f(value_type(target_type(0.5)*tinfo_type::min()),
			           value_type(target_type(0.5)*tinfo_type::max()));
        value v(f.value_1);
    ...
    BOOST_AUTO_TEST_CASE(test_as_complex32)
    {
        ...
        typedef pni::type_info<target_type> tinfo_type;
        fixture_type f(tinfo_type::min(),tinfo_type::max());
        value v(f.value_1);
        BOOST_CHECK_EQUAL(v.as<target_type>(),
                          convert<target_type>(f.value_1));
    ...
    BOOST_AUTO_TEST_CASE(test_as_complex64)
    {
        ...
        typedef pni::type_info<float64> tinfo_type;
        fixture_type f(value_type(float64(0.5)*tinfo_type::min()),
			           value_type(float64(0.5)*tinfo_type::max()));
        value v(f.value_1);
        BOOST_CHECK_EQUAL(v.as<target_type>(),
                          convert<target_type>(f.value_1));
