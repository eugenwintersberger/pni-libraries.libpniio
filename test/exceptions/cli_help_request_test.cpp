...
BOOST_AUTO_TEST_SUITE(cli_help_request_test)

    BOOST_AUTO_TEST_CASE(default_construction)
    {
        cli_help_request error;
        BOOST_CHECK_EQUAL(error.name(),"cli_help_request");
    ...
    {
        cli_help_request error(PNINEXUS_EXCEPTION_RECORD,"test error");
        BOOST_CHECK_EQUAL(error.name(),"cli_help_request");
