...
BOOST_AUTO_TEST_SUITE(cli_option_error_test)

    BOOST_AUTO_TEST_CASE(default_construction)
    {
        cli_option_error error;
        BOOST_CHECK_EQUAL(error.name(),"cli_option_error");
    ...
    {
        cli_option_error error(PNINEXUS_EXCEPTION_RECORD,"test error");
        BOOST_CHECK_EQUAL(error.name(),"cli_option_error");
