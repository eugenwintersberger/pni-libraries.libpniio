...
BOOST_AUTO_TEST_SUITE(cli_argument_error_test)

    BOOST_AUTO_TEST_CASE(default_construction)
    {
        cli_argument_error error;
        BOOST_CHECK_EQUAL(error.name(),"cli_argument_error");
    ...
    {
        cli_argument_error error(PNINEXUS_EXCEPTION_RECORD,"test error");
        BOOST_CHECK_EQUAL(error.name(),"cli_argument_error");
