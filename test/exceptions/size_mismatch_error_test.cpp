...
BOOST_AUTO_TEST_SUITE(size_mismatch_error_test)

    BOOST_AUTO_TEST_CASE(default_construction)
    {
        size_mismatch_error error;
        BOOST_CHECK_EQUAL(error.name(),"size_mismatch_error");
    ...
    {
        size_mismatch_error error(PNINEXUS_EXCEPTION_RECORD,"test error");
        BOOST_CHECK_EQUAL(error.name(),"size_mismatch_error");
