...
BOOST_AUTO_TEST_SUITE(memory_allocation_error_test)
    
    BOOST_AUTO_TEST_CASE(default_construction)
    {
        memory_allocation_error error;
        BOOST_CHECK_EQUAL(error.name(),"memory_allocation_error");
    ...
    {
        memory_allocation_error error(PNINEXUS_EXCEPTION_RECORD,"test error");
