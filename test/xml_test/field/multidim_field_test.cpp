...
struct multidim_field_fixture : field_test_fixture
{
    multidim_field_fixture():
        field_test_fixture("multidim_test_")
    { }
};

BOOST_FIXTURE_TEST_SUITE(multidim_field_test,multidim_field_fixture)
