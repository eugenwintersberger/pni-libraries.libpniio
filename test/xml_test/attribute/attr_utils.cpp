...
namespace attr{
    ...
    {
        return pni::io::nx::xml::attribute::size(node);
    }

    size_t rank(const pni::io::nx::xml::node &node)
    {
        return pni::io::nx::xml::attribute::rank(node);
    }

    pni::core::type_id_t type_id(const pni::io::nx::xml::node &node)
    {
        return pni::io::nx::xml::attribute::type_id(node);
    }
...
#define DEF_DATA_FROM_XML(type) \
    ...
    { \
        ...
        value = attribute::data_from_xml<type>(node); \
    }
...
#define DEF_DATA_TO_XML(type) \
    ...
    { \
        using namespace pni::io::nx::xml; \
        attribute::data_to_xml(node,value); \
    }
    ...
    {
        using namespace pni::io::nx::xml;
        return attribute::object_to_xml(object);
    }
    ...
    {
        using namespace pni::io::nx::xml;
        return attribute::object_from_xml(parent,node);
    }
}
}
