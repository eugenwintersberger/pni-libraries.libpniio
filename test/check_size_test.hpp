...
template<typename TA,typename TB> void check_size_test<TA,TB>::test_no_throw()
{
    ...
    CPPUNIT_ASSERT_THROW(check_size(a1,b2,EXCEPTION_RECORD),size_missmatch_error);
    //check with selection
    ...
    CPPUNIT_ASSERT_THROW(check_size(a2,field1,EXCEPTION_RECORD),size_missmatch_error);
    CPPUNIT_ASSERT_THROW(check_size(a2,attribute1,EXCEPTION_RECORD),size_missmatch_error);
    ...
    CPPUNIT_ASSERT_THROW(check_size(b1,field2,EXCEPTION_RECORD),size_missmatch_error);
    CPPUNIT_ASSERT_THROW(check_size(b1,attribute2,EXCEPTION_RECORD),size_missmatch_error);
}
