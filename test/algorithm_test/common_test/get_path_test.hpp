...
//! \brief test get_path function
//! 
//! Test the get_path function template. There are two implementations of this 
...
//! 
class get_path_test : public CppUnit::TestFixture
{
        CPPUNIT_TEST_SUITE(get_path_test);
