...
//! \brief test get_filename function
//! 
...
//! 
class get_filename_test : public CppUnit::TestFixture
{
        CPPUNIT_TEST_SUITE(get_filename_test);
        ...
        const string filename = "get_filename_test.nx";
