...
\begin{figure}[tb]
    ...
    \begin{tikzpicture}
        ...
        \node[directory node]{\texttt{run\_01}}
        child { node {\texttt{ASCII data}}}
        child { node [directory node] {\texttt{images}} 
            child{ node {\texttt{image\_001.tif}}}
            child{ node {\texttt{image\_002.tif}}}
            child{ node {\dots}}
            child{ node {\texttt{image\_100.tif}}}
        }
        child [missing] {}
        child [missing] {}
        child [missing] {}
