...
provides a C++ interface to their C-API too, \c libpninx is a pure C++
implementation providing all the ideoms a C++ programmer would expect from an
API. In contrary to the NIAC implementation \c libpninx supports only the HDF5
file format as a backend to store data (this is virtually its only restriction
in comparison to the existing C++ interface). Aside from this \c libpninx
...
efficiently \c libpninx will support both approaches.
...
care about locking. \c libpninx will do this job for you in future. 
...
such clusters under some restrictions. \c libpninx will support the MPI
