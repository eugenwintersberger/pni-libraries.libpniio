        ...
        namespace h5{
            ...
            class NXObjectH5Implementation {
                ...
                public:
                    ...
                    explicit NXObjectH5Implementation(const H5AttributeObject &o):
                        _object(o){}

                    //!copy constructor using 
                    explicit NXObjectH5Implementation(H5AttributeObject &&o):
                        _object(std::move(o)){}
                    ...
                    NXObjectH5Implementation &
                        operator= (const H5AttributeObject &o)
                    {
                        if(this == &o) return *this;
                        _object = o;
                        return *this;
