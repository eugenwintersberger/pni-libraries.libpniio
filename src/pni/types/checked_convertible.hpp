...
namespace pni{
    ...
    typedef boost::mpl::map<
        ...
        boost::mpl::pair<hdf5::datatype::EBool,boost::mpl::vector<>>,
    ...
    struct checked_convertible
    {
        ...
        typedef typename boost::mpl::at<checked_type_vectors,SourceT>::type map_element;
        //! type to check if TargetT is in the map
