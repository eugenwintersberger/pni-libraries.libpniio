...
namespace h5{
    ...
    class H5Dataset:public H5AttributeObject
    {
        ...
        public:
            ...
            //! to a dataset. If the H5Object does not refer to an HDF5 dataset 
            ...
            //! be thrown.
            //!
            //! \throws pni::io::nx::nxfield_error if o does not refer to a 
            //! dataset
            ...
            //! probably the simplest form of a dataset. Such a dataset cannot 
            //! be resized.  The shape of the dataspace is determined by the 
            //! argument s which is the intial as well as the maximum size 
            //! of the dataspace.
            //!
            //! \throws pni::io::nx::nxfield_error in case of all kinds of 
            //! errors
            ...
            //! Where the compression algorithm is applied to individual chunks 
            ...
            //! 
            //! Constructor can use an HDF5 object ID directly to instantiate 
            //! an HDF5 dataset. If the ID does not refer to a dataset an 
            //! exception will  be thrown.
            //!
            //! \throws pni::io::nx::nxfield_error if oid does not refer to a 
            //! dataset
            ...
            //! objects to describe the datatype and shape of the dataset.  In 
            //! virtually all cases it is more convenient to use a shape object 
            //! and a native type instead. This static template factory method 
            //! allows the creation of a H5Dataset object using the template 
            //! parameter to determin the datatype to use and a shape object 
            //! to describe the dataspace. The dataspaces created using this 
            //! method are infinitely extensible in along all dimensions.
            //!
            ...
            //! The method behaves exactly like static H5Dataset create( const 
            //! String &n,const H5Group &g,const Shape &s, const Shape &cs) 
            //! despite the fact that it requires an additional argument 
            //! describing the filter.
            //!
            //! \throws pni::io::nx::nxfield_error in case of errors
            //! \throws size_mismatch_error if chunk and dataset shape do not 
            //! have equal rank
            //! \param n name of the dataset
            //! \param g group below which the dataset will be created
            //! \param s shape describing the dataset
            ...
            {
                CTYPE s(_mspace.current_shape().size());
                std::copy(_mspace.current_shape().begin(),
                          _mspace.current_shape().end(),
                          s.begin());
                return s;
            }
