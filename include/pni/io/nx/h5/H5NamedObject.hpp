...
namespace h5{
    ...
    //! 
    //! Named objects are those objects in an HDF5 file that can be accessed 
    //! by a path or which have a name (this includes Files and attributes). 
    //! This class is used as a base class for such objects.  Due to the fact 
    //! that such objects can be linked. 
    //!
    class H5NamedObject:public H5Object
    {
        protected:
            ...
            //! 
            //! This protected constructor allows object construction form 
            //! an HDF5 ID. Only derived classes are supposed to use this 
            //! constructor.  The reference counter of the id passed will not 
            //! be altered.
            //!
            //! \param id HDF5 id
            //!
        ...
        public:
            ...
            //! a file object.
            //!
            //! \throws io_error in case of issues
            //!
