    ...
    class H5Dataspace:public H5Object
    {
        ...
        public:
            ...
            */
            ...
            //! \brief destructor
            //!
            //! As the destructor is not virtual this class must not be used 
            ...
            //! 
            //! This method returns a const reference to the internal buffer 
            //! holding the actual number of elements along each dimension. 
            //! For a dataspace representing a scalar value this will be an 
            //! empty buffer.  The aim of this method is to provide a quick 
            //! way to access the shape of a dataspace.
            //!
