...
namespace h5{
    ...
    //! oprovides all the methods responsible for manging attributes.
    //!
    class H5AttributeObject:public H5NamedObject
    {
        ...
        public:
            ...
            */
            ...
            //!
            //! Create a scalar attribute of type T. Such an attribute can only 
            //! take a single value of type T. The type T must be provided 
            //! explicitly in the code. The method returns an instance of 
            //! H5Attribute. If an attribute of name n already exists an 
            //! exception will be thrown unless ov in the parameter list of 
            ...
            template<
                     ...
                     typename ItemT
                    > 
            friend class H5LinkIterator;
    };

    //===================implementation of template methods====================
    template<typename T> H5Attribute
    H5AttributeObject::__create_attr(const string &n, bool ov,
