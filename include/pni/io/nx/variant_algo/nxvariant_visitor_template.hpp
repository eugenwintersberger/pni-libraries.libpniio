...
namespace nx{
    ...
    */
    ...
    This function is a wrapper to the get_size_visitor template. It returns the
    total number of elements held by a field or attribute stored in a variant
    type. If the stored object is agroup an exception will be thrown.
