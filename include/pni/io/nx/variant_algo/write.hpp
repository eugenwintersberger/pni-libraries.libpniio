...
namespace nx{
    ...
    This visitor writes data to  a field or attribute. Partial IO is supported
    only for fields. If partial IO is tried on an attribute object a selection
    will be thrown. As one cannot write data to a group an exception will be
    thrown if the stored type is a group type.
    ...
    */
    ...
    class write_visitor : public boost::static_visitor<void>
    {
        ...
        public:
            ...
            */
            ...
            Write data to an attribute. If the selection member is not empty an
    ...
    This function template is a wrapper for the write_visitor. It will write
    data to the field or attribute stored in the variant type. 
