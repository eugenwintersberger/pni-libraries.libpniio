...
namespace xml{
    ...
    //!
    //! This function is a wrapper around the create_group_visitor template. 
    //! It returns a new group as a variant object created below its parent 
    //! group.
    /*!
    \code{.cpp}
    ...
    \endcode
    */
    //! All the information about the new group is drawn from XML data which 
    //! is of form 
    /*!
    \code{.xml}
    ...
    \endcode
    */
    //! Wile the \c type attribute is optional the \c name attribute is 
    //! absolutely mandatory as you cannot create a group without a name. 
    //! The content of the \c type attribute goes to the \c NX_class 
    //! attribute of the newly create group and determines the Nexus base 
    //! class the new gruop belongs too. 
    //!
