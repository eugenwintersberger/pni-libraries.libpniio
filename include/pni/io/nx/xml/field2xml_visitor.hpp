...
namespace xml{
    ...
    class field2xml_visitor : public boost::static_visitor<node>
    {
        private: 
        ...
        public:
            ...
            //!
            create_field_visitor(const node &n): _xml_node(n)
            {}
    ...
    */
    ...
    //! representation of the physical unit of the data. The latter one is 
    //! a string attribute too with a more detailed description of the 
    //! data. 
    //!
